...
# VGA
#============================================================
set_location_assignment PIN_AF21 -to VGA_R[2]
set_location_assignment PIN_AG19 -to VGA_R[1]
set_location_assignment PIN_AH19 -to VGA_R[0]
#set_location_assignment PIN_AA20 -to VGA_R[3]
#set_location_assignment PIN_AG21 -to VGA_R[4]
#set_location_assignment PIN_AG24 -to VGA_R[5]

set_location_assignment PIN_AG18 -to VGA_G[2]
set_location_assignment PIN_AH18 -to VGA_G[1]
set_location_assignment PIN_AF18 -to VGA_G[0]
#set_location_assignment PIN_AH22 -to VGA_G[3]
...
set_location_assignment PIN_AG15 -to VGA_B[1]
set_location_assignment PIN_AE20 -to VGA_B[0]
...
# AUDIO
#============================================================
set_location_assignment PIN_AC24 -to AUDIO_R_DIRECT
set_location_assignment PIN_AE25 -to AUDIO_L_DIRECT
...
set_location_assignment PIN_Y15 -to EAR_PORT
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to EAR_PORT

set_location_assignment PIN_AA15 -to MIC_PORT
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to MIC_PORT
...
#set_location_assignment PIN_AG28 -to BTN_RESET
set_location_assignment PIN_AG28 -to BTN_IRESET
set_location_assignment PIN_AF28 -to BTN_NMI
set_location_assignment PIN_AD26 -to BTN_DIVMMC
