...
#//Assignments for beta board only
set_location_assignment PIN_AG25 -to JOY_IN_1_PIN1
set_location_assignment PIN_AH24 -to JOY_IN_1_PIN4
set_location_assignment PIN_AG23 -to JOY_IN_1_PIN3
set_location_assignment PIN_AG24 -to JOY_IN_1_PIN2
set_location_assignment PIN_AH21 -to JOY_IN_1_PIN9
set_location_assignment PIN_AG20 -to JOY_OUT_1_PIN7
set_location_assignment PIN_AF22 -to JOY_IN_1_PIN6

set_location_assignment PIN_AH26 -to JOY_IN_2_PIN1
set_location_assignment PIN_AF25 -to JOY_IN_2_PIN4
set_location_assignment PIN_AF23 -to JOY_IN_2_PIN3
set_location_assignment PIN_AH22 -to JOY_IN_2_PIN2
set_location_assignment PIN_AG21 -to JOY_IN_2_PIN9
set_location_assignment PIN_AA20 -to JOY_OUT_2_PIN7
set_location_assignment PIN_AE22 -to JOY_IN_2_PIN6

#//Correct assignment - ones above are for incorrect wiring on beta board
#set_location_assignment PIN_AG25 -to JOY_IN_1_PIN1
#set_location_assignment PIN_AH24 -to JOY_IN_1_PIN2
#set_location_assignment PIN_AG23 -to JOY_IN_1_PIN3
#set_location_assignment PIN_AG24 -to JOY_IN_1_PIN4
#set_location_assignment PIN_AH21 -to JOY_IN_1_PIN6
#set_location_assignment PIN_AG20 -to JOY_OUT_1_PIN7
#set_location_assignment PIN_AF22 -to JOY_IN_1_PIN9

#set_location_assignment PIN_AH26 -to JOY_IN_2_PIN1
#set_location_assignment PIN_AF25 -to JOY_IN_2_PIN2
#set_location_assignment PIN_AF23 -to JOY_IN_2_PIN3
#set_location_assignment PIN_AH22 -to JOY_IN_2_PIN4
#set_location_assignment PIN_AG21 -to JOY_IN_2_PIN6
#set_location_assignment PIN_AA20 -to JOY_OUT_2_PIN7
#set_location_assignment PIN_AE22 -to JOY_IN_2_PIN9
...
set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to JOY_IN*
...
# SRAM
#============================================================
set_location_assignment PIN_W12 -to SRAM_A[0]
set_location_assignment PIN_D8 -to SRAM_A[1]
set_location_assignment PIN_AF7 -to SRAM_A[2]
set_location_assignment PIN_AF4 -to SRAM_A[3]
set_location_assignment PIN_AD5 -to SRAM_A[4]
set_location_assignment PIN_AE23 -to SRAM_A[5]
set_location_assignment PIN_AD23 -to SRAM_A[6]
set_location_assignment PIN_D12 -to SRAM_A[7]
set_location_assignment PIN_C12 -to SRAM_A[8]
set_location_assignment PIN_AC23 -to SRAM_A[9]
set_location_assignment PIN_Y19 -to SRAM_A[10]
set_location_assignment PIN_AA19 -to SRAM_A[11]
set_location_assignment PIN_AA18 -to SRAM_A[12]
set_location_assignment PIN_Y18 -to SRAM_A[13]
set_location_assignment PIN_AB25 -to SRAM_A[14]
set_location_assignment PIN_Y11 -to SRAM_A[15]
set_location_assignment PIN_AA26 -to SRAM_A[16]
set_location_assignment PIN_AA13 -to SRAM_A[17]
set_location_assignment PIN_AA11 -to SRAM_A[18]

set_location_assignment PIN_E8 -to SRAM_DQ[0]
set_location_assignment PIN_D11 -to SRAM_DQ[1]
set_location_assignment PIN_AH13 -to SRAM_DQ[2]
set_location_assignment PIN_AH14 -to SRAM_DQ[3]
set_location_assignment PIN_AH3 -to SRAM_DQ[4]
set_location_assignment PIN_AG14 -to SRAM_DQ[5]
set_location_assignment PIN_AE6 -to SRAM_DQ[6]
set_location_assignment PIN_AE24 -to SRAM_DQ[7]
set_location_assignment PIN_AD20 -to SRAM_DQ[8]
set_location_assignment PIN_AD17 -to SRAM_DQ[9]
set_location_assignment PIN_AC22 -to SRAM_DQ[10]
set_location_assignment PIN_AB23 -to SRAM_DQ[11]
set_location_assignment PIN_W11 -to SRAM_DQ[12]
set_location_assignment PIN_W14 -to SRAM_DQ[13]
set_location_assignment PIN_Y17 -to SRAM_DQ[14]
set_location_assignment PIN_AB26 -to SRAM_DQ[15]

set_location_assignment PIN_V12 -to SRAM_nWE
set_location_assignment PIN_U14 -to SRAM_nCS[0]
set_location_assignment PIN_AG9 -to SRAM_nCS[1]
set_location_assignment PIN_AG10 -to SRAM_nCS[2]
set_location_assignment PIN_AF13 -to SRAM_nCS[3]

set_location_assignment PIN_AG13 -to SRAM_nOE
...
set_location_assignment PIN_U13 -to SD_SPI_CLK
set_location_assignment PIN_AH23 -to SD_SPI_MOSI
set_location_assignment PIN_AH27 -to SD_SPI_MISO
set_location_assignment PIN_AG26 -to SD_SPI_CS
set_location_assignment PIN_AF27 -to SD_SPI_CS1
